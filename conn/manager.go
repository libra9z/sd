...
func NewManager(d Dialer, network, address string, after AfterFunc, logger l4g.Logger) *Manager {
	m := &Manager{
		dialer:  d,
		network: network,
		address: address,
...
func NewDefaultManager(network, address string, logger l4g.Logger) *Manager {
...
func dial(d Dialer, network, address string, logger l4g.Logger) net.Conn {
